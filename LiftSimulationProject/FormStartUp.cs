...
namespace View
{
    public partial class FormStartUp : Form, IViewStartUp
    {
        ...
        public FormStartUp()
        {
            ...
            AutofacContainerProvider.Container = AutofacBuilder.Build();
            presenterFactory = AutofacContainerProvider.Container.Resolve<PresenterStartUp.Factory>();
        ...
        public void CreateShowMonitoringForm()
        {
            MyApplicationContext.createMonitoringForm().Show();
        }

        public void CreateShowInteriorObservationForm()
        {
